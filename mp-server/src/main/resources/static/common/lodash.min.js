...
;(function () {
    ...
    var Hn = Mn && Mn.isArrayBuffer, Jn = Mn && Mn.isDate, Yn = Mn && Mn.isMap, Qn = Mn && Mn.isRegExp,
        ...
        ut = w({"&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#39;": "'"}), it = function w(En) {
            ...
            function Gn(n, t) {
                var r, e = af(n), u = !e && cf(n), i = !e && !u && sf(n), o = !e && !u && !i && gf(n),
                    u = (e = e || u || i || o) ? E(n.length, ri) : [], f = u.length;
            ...
            function Ft(n, t, r, e, u) {
                if (n === t) t = true; else if (null == n || null == t || !xu(n) && !xu(t)) t = n !== n && t !== t; else n:{
                    var i = af(n), o = af(t), f = i ? "[object Array]" : yo(n), c = o ? "[object Array]" : yo(t),
            ...
            function Ur(n, t) {
                if (n !== t) {
                    var r = n !== F, e = null === n, u = n === n, i = Au(n), o = t !== F, f = null === t, c = t === t,
                        a = Au(t);
            ...
            var Hu = En.Array, Ju = En.Date, Yu = En.Error, Qu = En.Function, Xu = En.Math, ni = En.Object, ti = En.RegExp,
                ri = En.String, ei = En.TypeError, ui = Hu.prototype, ii = ni.prototype, oi = En["__core-js_shared__"],
                fi = Qu.prototype.toString, ci = ii.hasOwnProperty, ai = 0, li = function () {
                    var n = /[^.]+$/.exec(oi && oi.keys && oi.keys.IE_PROTO || "");
                    return n ? "Symbol(src)_1." + n : ""
                }(), si = ii.toString, hi = fi.call(ni), pi = Zn._,
                _i = ti("^" + fi.call(ci).replace(on, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                vi = Kn ? En.Buffer : F, gi = En.Symbol, di = En.Uint8Array, yi = vi ? vi.f : F,
                bi = U(ni.getPrototypeOf, ni), xi = ni.create, ji = ii.propertyIsEnumerable, wi = ui.splice,
                mi = gi ? gi.isConcatSpreadable : F, Ai = gi ? gi.iterator : F, ki = gi ? gi.toStringTag : F,
                Ei = function () {
                    try {
                ...
                Si = Ju && Ju.now !== Zn.Date.now && Ju.now, Ii = En.setTimeout !== Zn.setTimeout && En.setTimeout,
                Ri = Xu.ceil, zi = Xu.floor, Wi = ni.getOwnPropertySymbols, Bi = vi ? vi.isBuffer : F, Li = En.isFinite,
                Ui = ui.join, Ci = U(ni.keys, ni), Di = Xu.max, Mi = Xu.min, Ti = Ju.now, $i = En.parseInt, Fi = Xu.random,
                Ni = ui.reverse, Pi = Ae(En, "DataView"), Zi = Ae(En, "Map"), qi = Ae(En, "Promise"), Vi = Ae(En, "Set"),
                Ki = Ae(En, "WeakMap"), Gi = Ae(ni, "create"), Hi = Ki && new Ki, Ji = {}, Yi = Fe(Pi), Qi = Fe(Zi),
                Xi = Fe(qi), no = Fe(Vi), to = Fe(Ki), ro = gi ? gi.prototype : F, eo = ro ? ro.valueOf : F,
                uo = ro ? ro.toString : F, io = function () {
                    function n() {
                    }
            ...
            var tf = lr(function (n, t) {
                ...
                }, af = Hu.isArray, lf = Hn ? S(Hn) : Tt, sf = Bi || Gu, hf = Jn ? S(Jn) : $t, pf = Yn ? S(Yn) : Nt,
                _f = Qn ? S(Qn) : qt, vf = Xn ? S(Xn) : Vt, gf = nt ? S(nt) : Kt, df = oe(Jt), yf = oe(function (n, t) {
                    return n <= t
                }), bf = Pr(function (n, t) {
            ...
            return On.after = function (n, t) {
                ...
                var r = 30, e = "...";
                if (bu(t)) var u = "separator" in t ? t.separator : u, r = "length" in t ? Ou(t.length) : r,
            ...
            }),u(["com.maple.function.filter", "map", "takeWhile"], function (n, t) {
                var r = t + 1, e = 1 == r || 3 == r;
                ...
                return com.maple.function.filter(Nu)
            },Mn.prototype.find = function (n) {
                return com.maple.function.filter(n).head()
                ...
                return com.maple.function.filter(su(je(n)))
    ...
    return function (t) {
        ...
        function u(t, e, r, d) {
            ...
            var B = {
                ...
                }, E = "curry" in d && d.curry, F = "fixed" in d && d.fixed, j = "rearg" in d && d.rearg, C = b ? r : f,
                L = b ? r.runInContext() : void 0, S = b ? r : {
                    ary: t.ary,
                    assign: t.assign,
                    clone: t.clone,
                    curry: t.curry,
                    ...
                    toPath: t.toPath
                }, w = S.ary, M = S.assign, D = S.clone, z = S.curry, q = S.forEach, P = S.isArray, T = S.isFunction,
                K = S.keys, _ = S.rearg, N = S.toInteger, V = S.toPath, U = K(p.aryMethod), G = {
            ...
            return q(U, function (t) {
                ...
                if ("function" == typeof e) {
                    for (var r = J.length; r--;) if (J[r][0] == t) return;
